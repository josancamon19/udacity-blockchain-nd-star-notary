...
it('can add the star name and star symbol properly', async () => {
    ...
    let user1 = accounts[1];
    let starId = 6;
    await instance.createStar('40 Eridani', starId, {
        from: user1
    });
...
it('lets 2 users exchange stars', async () => {
    ...
    let starId1 = 7;
    let starId2 = 8;
    await instance.createStar('Eridani 401', starId1, {
        from: user1
    });
    await instance.createStar('Eridani 402', starId2, {
        from: user2
    });
    ...
    // assert.equal(await instance.ownerOf(user1));
});
...
it('lets a user transfer a star', async () => {
    ...
    await instance.transferStar(user2, 10, {
        from: user1
    });
...
it('lookUptokenIdToStarInfo test', async () => {
    ...
    assert.equal(starName, '40 Eridani');
});